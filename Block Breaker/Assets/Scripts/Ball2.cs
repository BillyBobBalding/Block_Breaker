...
public class Ball2 : MonoBehaviour
{
    ...
    [SerializeField] Paddle2 paddle2;
	...
	void Start ()
    {
        paddleToBallVector = transform.position - paddle2.transform.position;
    ...
    {
            Vector2 paddlePoss = new Vector2(paddle2.transform.position.x, paddle2.transform.position.y);
